...
if args.save:
    cifar10["train_data"] = train_data
    cifar10["test_data"] = test_data
    file_path = './data/sampled_cifar10/cifar10_20000_tobject_rotation.pkl'
    ...
    # file_path = './data/sampled_cifar10/cifar10_20000_tcolor_object.pkl'
    # with open(file_path, "wb") as f:
    #     entry = pickle.dump(cifar10, f)
    ...
    file_path = './data/sampled_cifar10/cifar10_20000_trotation_object.pkl'
    with open(file_path, "wb") as f:
        entry = pickle.dump(cifar10, f)

...
parser.add_argument('--crop_linear_noise', action='store_true', default=False)
parser.add_argument('--linear_noise_filter', action='store_true', default=False)

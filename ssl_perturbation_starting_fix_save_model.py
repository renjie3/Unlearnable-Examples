...
def main():
    ...
    # Here we load the pre-trained model on a clean set. 20211008231026_128_0.5_200_512_1000_model.pth
    # for name in model.state_dict():
    #     print(name)
    # sys.exit()
    flops, params = profile(model, inputs=(torch.randn(1, 3, 32, 32).cuda(),))
    flops, params = clever_format([flops, params])
    fix_model_path = "./fix_checkpoint/20211008231026_128_0.5_200_512_1000_model.pth"
    model.load_state_dict(torch.load(fix_model_path))

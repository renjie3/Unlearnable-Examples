...
parser.add_argument('--feature_length', default=20, type=int, help='feature_length')
...
for i_distri in range(1):
    ...
    memory_sampled["train_targets"] = test_targets
    ...
    if args.save:
        file_path = './data/theory_data/hierarchical_period_dim{}{}{}{}_knn{}.pkl'.format(args.feature_length, shuffle_str, std_str, bias_scalor_str, n_distri)
        print(file_path)
    ...
    if args.save:
        file_path = './data/theory_data/hierarchical_period_dim{}{}{}{}_test{}_knn{}.pkl'.format(args.feature_length, shuffle_str, std_str, bias_scalor_str, i_distri+1, n_distri)
        print(file_path)
        with open(file_path, "wb") as f:

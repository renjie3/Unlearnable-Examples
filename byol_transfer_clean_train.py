...
from byol_utils import test_ssl_for_byolpy, train_byol, test_byol
...
def train(net, data_loader, train_optimizer):
    ...
    for pos_1, pos_2, target in train_bar:
        ...
        batch_train_loss, batch_size_count = train_byol(model, pos_1, pos_2, train_optimizer, args.batch_size, args.temperature, noise_after_transform=False)
...
if __name__ == '__main__':
    ...
    if class_4:
        ...
        if args.clean_train:
            save_name_pre = pre_load_name + "_byol_cleantrain_{}_budget{}_class10".format(args.train_data_type, perturbation_budget)
        else:
    ...
    for _epoch in range(1, epochs + 1):
        ...
        test_acc_1, test_acc_5 = test_byol(model, memory_loader, test_loader, k, temperature, epoch, epochs)

...
if args.center:
    if args.train:
        file_path = './data/sampled_cifar10/cifar10_1024_4class_mnist_mixed_random_samplewise_center_train_{}_budget{}.pkl'.format(mnist_size, multi_budget*8)
    else:
        file_path = './data/sampled_cifar10/cifar10_1024_4class_mnist_mixed_random_samplewise_center_all_{}_budget{}.pkl'.format(mnist_size, multi_budget*8)
else:
    if args.train:
        file_path = './data/sampled_cifar10/cifar10_1024_4class_mnist_mixed_random_samplewise_corner_train_{}_budget{}.pkl'.format(mnist_size, multi_budget*8)
    else:
        file_path = './data/sampled_cifar10/cifar10_1024_4class_mnist_mixed_random_samplewise_corner_all_{}_budget{}.pkl'.format(mnist_size, multi_budget*8)

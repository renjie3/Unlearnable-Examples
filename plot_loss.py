...
file_prename = "./results/unlearnable_samplewise_104755714_20211115144151_0.5_512_1000_checkpoint_perturbation_budget1.0_class4_retrain_model_statistics"
# 20211031144658
pd_reader = pd.read_csv(file_prename+".csv")
# print(pd_reader)

# unlearnable_samplewise_107351014_1_20211117185722_0.5_512_1000perturbation_budget1.0_class4_retrain_model_statistics budget_8_eot
# unlearnable_samplewise_104763711_20211115145540_0.5_512_1000_checkpoint_perturbation_budget1.0_class4_retrain_model_statistics budget_8
# unlearnable_samplewise_104755714_20211115144151_0.5_512_1000_checkpoint_perturbation_budget1.0_class4_retrain_model_statistics budget_32
...
p2 = ax.plot(epoch1, loss,'r-', label = 'loss')
p2 = ax.plot(epoch1, loss1,'g-', label = 'clean_loss')
ax.legend()
...
ax.set_ylabel('loss')
ax1.set_ylabel('acc')
plt.title('samplewise budget 32')
